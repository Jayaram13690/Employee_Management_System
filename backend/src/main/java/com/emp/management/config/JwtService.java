...
/**
 * JWT utility service — handles token creation, parsing, and validation.
 */
@Service
public class JwtService {
    ...
    /**
     * Generate a JWT token for the given user with default claims.
     */
    ...
    /**
     * Generate a JWT token with extra claims (e.g., role, employeeId).
     */
